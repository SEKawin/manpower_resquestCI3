        ...
        <div class="jumbotron text-left" style="background-color: LightSteelBlue">
            ...
            <div class="row col-md-12">
                <div class=" page-header">
                    <h3>Approver Database <small>รายการผู้อนุมัติต้นสังกัด</small></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <?php echo form_open('account/approver_add'); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a title="ลบ" class="btn btn-sm btn-danger"
                                            href="<?php echo site_url('account/approver_remove/'); ?><?php echo $rows->pt_account_id ?>"
