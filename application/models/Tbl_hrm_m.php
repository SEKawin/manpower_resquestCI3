<?php
class tbl_hrm_m extends CI_Model
{
    ...
    private function _get_datatables_query_hrm_mgr()
    {
        ...
        $this->db->order_by('app_manp_form.status_hrm_mgr', 'ASC');
    ...
    public function get_datatables_hrm_mgr()
    {
        $this->_get_datatables_query_hrm_mgr();
    ...
    public function count_filtered_hrm_mgr()
    {
        $this->_get_datatables_query_hrm_mgr();
        $query = $this->db->get();
    ...
    private function _get_datatables_query_hrm_agm()
    {
        $code = $this->session->userdata('code');
        ...
        $this->db->join($this->app_manp_form, 'app_manp_form.form_id = manpower_form.id', 'LEFT');
        $this->db->where('manpower_form.removed', 0);
        $this->db->where('app_manp_form.status_hrm_mgr', 1);
        $this->db->where('app_manp_form.hrm_agm_code',$code);
        $this->db->group_by('manpower_form.hr_no');
        $this->db->group_by('manpower_form.year');
        $this->db->order_by('app_manp_form.status_hrm_agm', 'ASC');
        $this->db->order_by('manpower_form.create_date', 'DESC');
    ...
    public function get_datatables_hrm_agm()
    {
        $this->_get_datatables_query_hrm_agm();
    ...
    public function count_filtered_hrm_agm()
    {
        $this->_get_datatables_query_hrm_agm();
        $query = $this->db->get();
        return $query->num_rows();
    ...
    private function _get_datatables_query_hrm_gm()
    {
        $code = $this->session->userdata('code');
        ...
        $this->db->where('manpower_form.removed', 0);
        $this->db->where('app_manp_form.status_hrm_mgr', 1);
        // $this->db->where('app_manp_form.status_hrm_agm', 1);
        $this->db->where('app_manp_form.od_code',$code);
        $this->db->group_by('manpower_form.hr_no');
        $this->db->group_by('manpower_form.year');
        $this->db->order_by('app_manp_form.status_od', 'ASC');
        $this->db->order_by('manpower_form.create_date', 'DESC');
    ...
    public function get_datatables_hrm_gm()
    {
        $this->_get_datatables_query_hrm_gm();
    ...
    public function count_filtered_hrm_gm()
    {
        $this->_get_datatables_query_hrm_gm();
        $query = $this->db->get();
        return $query->num_rows();
